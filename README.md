# node-js-telegram-bot-template

A barebones Node.js telegram bot using [Telegraf](https://telegraf.js.org/). It is ready to deploy on heroku or run on local environment.
...
2. Run following command
		...
		$ git clone https://bitbucket.org/makeitrun/node-js-telegram-bot-template.git # or clone your own fork
